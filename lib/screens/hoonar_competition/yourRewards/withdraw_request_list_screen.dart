                ...
                children: [
                  Column(
                    children: [
                      ...
                      Center(
                          child: GradientText(
                        AppLocalizations.of(context)!.withdraw_request_list,
                        style: GoogleFonts.poppins(
                          fontSize: 20,
                          color: myLoading.isDark ? Colors.black : Colors.white,
                      ...
                      contestProvider.isWithdrawTransactionLoading ||
                              contestProvider.withdrawRequestListModel == null
                          ? const WalletTransactionShimmer()
                          : contestProvider.withdrawRequestListModel!.data ==
                                      null ||
                                  contestProvider
                                      .withdrawRequestListModel!.data!.isEmpty
                              ? DataNotFound()
                              : ListView.builder(
                                  ...
                                  itemCount: contestProvider
                                      .withdrawRequestListModel!.data!.length,
                                  itemBuilder: (context, index) {
                                    WithdrawRequestList model = contestProvider
                                        .withdrawRequestListModel!.data![index];
                                    return Container(
                                      margin:
