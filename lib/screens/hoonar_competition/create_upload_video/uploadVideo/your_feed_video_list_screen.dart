...
class YourFeedVideoListScreen extends StatefulWidget {
  const YourFeedVideoListScreen({super.key});
                        ...
                        onTap: () {
                          SoundList soundListModel = SoundList(
                              ...
                              soundImage: contestProvider.draftFeedListModel!
                                  ...
                                  '',
                              soundId: contestProvider.draftFeedListModel!.data!
                                          .yourFeed![index].soundId !=
                                      ""
                          ...
                          Navigator.push(
                            ...
                            SlideRightRoute(
                              ...
                              from: "feed",
                              selectedMusic: contestProvider.draftFeedListModel!
                                          .data!.yourFeed![index].soundTitle ==
                                      ""
                                  ? null
                                  : soundListModel,
